...
char* inputString(istream&, int);										//прототип функции ввода строки
char* inputCyrillicString(istream&, int);								//прототип функции ввода кириллической строки
char* inputLatinicString(istream&, int);								//прототип функции ввода латинской строки